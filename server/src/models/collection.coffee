...
ExtendedField = require('./extendedfield').ExtendedField
...
class Collection extends ForaDbModel
    ...
    class ExtendedCollectionField extends ExtendedField
        @describeType: {
            collection: 'collectionfields',
            inherits: ExtendedField
        }
    ...
    @describeType: {
        ...
        fields: {
            ...
            recordTypes: { type: 'array', contentType: 'string' },
        ...
        extendedFields: {
            fields : {
                message: { type: "string", model: ExtendedCollectionField },
                about: { type: "string", model: ExtendedCollectionField }
            }
        }  
        logging: {
                onInsert: 'NEW_FORUM'
