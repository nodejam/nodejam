...
movies = {
    ...
    cover_src: 'http://theredlist.fr/media/database/muses/couples/hollywood/paulette_godard_charlie_chaplin/017_paulette_godard_charlie_chaplin_theredlist.jpg',
    permission: 'public',    
    type: 'public',
    category: 'movies',
    _createdBy: 'aaronsw'      
...
rawNerve = {
    ...
    cover_src: 'http://farm9.staticflickr.com/8384/8462699292_1f68a9cd3e_b.jpg',
    permission: 'public',
    type: 'public',
    category: 'life',
