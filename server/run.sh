...
start_processes() {
    ...
    node --harmony $api_debug $long_stack app/api/index.js localhost 10982 fora_api "$@" 2> apierrors.log &
    node --harmony $web_debug $long_stack app/web/index.js localhost 10981 fora_website "$@" 2> weberrors.log &
}
